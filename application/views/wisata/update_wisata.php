...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Form Update Wisata</h5>
            <div class="heading-elements">
                <ul class="icons-list">
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="<?= site_url('Admin/update_wisata/' . $wisata['id_wisata']); ?>" method="POST" enctype="multipart/form-data">
                <fieldset class="content-group">
                    <legend class="text-bold">Update Wisata</legend>

                    <div class="form-group">
                        <div class="col-lg-10">
                            <input type="text" class="form-control" disabled name="id" value="<?= $wisata['id_wisata']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <div class="content-group">
                                <textarea id="editor-full" rows="4" cols="4" class="form-control" name="deskripsi_wisata"> <?= $wisata['deskripsi_wisata']; ?></textarea>
                                <td><?php echo form_error('deskripsi_wisata'); ?></td>
                            </div>
                        </div>
                    </div>

                    <input type="text" class="file-styled" name="old_foto" value="<?= $wisata['foto']; ?>">
                    <div class="form-group">
